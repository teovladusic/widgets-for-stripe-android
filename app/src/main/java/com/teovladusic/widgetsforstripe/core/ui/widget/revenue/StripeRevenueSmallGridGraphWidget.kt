...
class StripeRevenueSmallGridGraphWidget : GlanceAppWidget() {
    ...
    private fun Widget(project: StripeProjectWithCharges?) {
        val charges112DaysAgo = project?.charges49DaysAgoAmount ?: return
...
class StripeRevenueSmallGridGraphWidgetReceiver : GlanceAppWidgetReceiver() {
    override val glanceAppWidget: GlanceAppWidget
        get() = StripeRevenueSmallGridGraphWidget()
}
